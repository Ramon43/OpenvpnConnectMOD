...
public class PrefUtil {
    ...
    public String get_string_by_profile(String profile_name, String key) {
        try {
            ...
            Log.d(TAG, String.format("get_string_by_profile: key='%s' value='%s'", new Object[]{key, value}));
            return value;
        } catch (ClassCastException e) {
    ...
    public boolean get_boolean_by_profile(String profile_name, String key, boolean default_value) {
        try {
            ...
            Log.d(TAG, String.format("get_boolean_by_profile: key='%s' value=%b", new Object[]{key, Boolean.valueOf(value)}));
            return value;
        } catch (ClassCastException e) {
