...
public class ClientAPI_ExternalPKISignRequest extends ClientAPI_ExternalPKIRequestBase {
    ...
    public void setSigType(String value) {
        ovpncliJNI.ClientAPI_ExternalPKISignRequest_sigType_set(this.swigCPtr, this, value);
    }

    public String getSigType() {
        return ovpncliJNI.ClientAPI_ExternalPKISignRequest_sigType_get(this.swigCPtr, this);
    }
